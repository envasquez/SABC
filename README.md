...
Please see the [Wiki](https://github.com/envasquez/SABC/wiki) for an informal write-up to capture some requirements, this site's purpose, solution space and design decisions. Basically ... a one page specification.
