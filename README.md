...
Please see the [Wiki](https://github.com/envasquez/SABC/wiki/SABC---One-page-specification-and-Ideas-...) for an informal write-up to capture some requirements, this site's purpose, solution space and design decisions.
