...
class CalendarEvent(models.Model):
    ...
    category = models.CharField(
        ...
        default=EventCategory.TOURNAMENT
    )
    ...
    external_url = models.URLField(blank=True, null=True, help_text="Link to external event info")
    ...
    def color_class(self):
        ...
        return color_map.get(self.category, 'sabc-default')
    ...
    def icon_class(self):
        ...
        return icon_map.get(self.category, 'bi-calendar-event')
...
def create_default_holidays(year):
    ...
    holidays = [
        ...
        {'title': "Martin Luther King Day", 'date': f'{year}-01-15', 'category': 'holiday'},  # Approximate
        {'title': "Presidents Day", 'date': f'{year}-02-19', 'category': 'holiday'},  # Approximate
        {'title': "Memorial Day", 'date': f'{year}-05-27', 'category': 'holiday'},  # Approximate
        {'title': "Independence Day", 'date': f'{year}-07-04', 'category': 'holiday'},
        {'title': "Labor Day", 'date': f'{year}-09-02', 'category': 'holiday'},  # Approximate
        {'title': "Thanksgiving", 'date': f'{year}-11-28', 'category': 'holiday'},  # Approximate
