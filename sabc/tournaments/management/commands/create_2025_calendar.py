...
from tournaments.models.tournaments import Events, Tournament
    ...
    def handle(self, *args, **options):
        ...
        external_events = [
            (
                ...
                lakes["LBJ"],
                "External tournament on LBJ",
            ),
            (
                "2025-01-25",
                "TTZ Tournament",
                lakes["Buc"],
                "TTZ tournament on Buchanan",
            ),
            (
                "2025-02-22",
                "Fishers of Men Tournament",
                lakes["Still House"],
                "External tournament on Still House",
            ),
            (
                "2025-03-22",
                "High School Tournament",
                lakes["Buc"],
                "High school tournament on Buchanan",
            ),
            (
                "2025-03-22",
                "Fishers of Men Tournament",
                lakes["Buc"],
                "External tournament on Buchanan",
            ),
            ...
            (
                ...
                "High School Tournament",
                lakes["LBJ"],
                "High school tournament on LBJ",
            ),
            (
                "2025-04-26",
                "Bass Champs Tournament",
                lakes["Belton"],
                "Bass Champs tournament on Belton",
            ),
        ]
