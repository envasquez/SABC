...
urlpatterns = [
    ...
    re_path(r'^tournament/new/$', tournament_views.TournamentCreateView.as_view(), name='tournament-create'),
    re_path(r'^tournament/(?P<pk>\d+)/$', tournament_views.TournamentDetailView.as_view(), name='tournament-details'),
    re_path(r'^tournament/(?P<pk>\d+)/update/$', tournament_views.TournamentUpdateView.as_view(), name='tournament-update'),
    re_path(r'^tournament/(?P<pk>\d+)/delete/$', tournament_views.TournamentDeleteView.as_view(), name='tournament-delete'),
    re_path(r'^tournament/(?P<pk>\d+)/add_team/$', tournament_views.TeamCreateView.as_view(), name='team-create'),
    re_path(r'^tournament/(?P<pk>\d+)/list_teams/$', tournament_views.TeamListView.as_view(), name='team-list'),
    re_path(r'^team/(?P<pk>\d+)/$', tournament_views.TeamDetailView.as_view(), name='team-details'),
    re_path(r'^tournament/(?P<pk>\d+)/add_result/$', tournament_views.ResultCreateView.as_view(), name='result-create'),
]
if settings.DEBUG:
